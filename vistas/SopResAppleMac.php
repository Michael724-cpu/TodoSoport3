...
{
    $stmt = $conexion->prepare("SELECT IdCategoria, Nombre, Descripcion, Precio FROM catproducto WHERE IdCategoria = '18' AND IdProducto = :idProducto");
...
try {
    $categoriaQuery = $conexion->prepare("SELECT IdCategoria, Nombre, Descripcion FROM catcategoria WHERE IdCategoria = '18'");
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <img class="img-fluid" src="../icons/desarrollo-de-aplicaciones.png" alt="">
            </div>
...
<div class="container-xxl py-5">
    <div class="container px-lg-5">
        ...
        <div class="row g-4">
            ...
            $productosIds = [146,147,148,149,150,151,152,153,154,155,156,157];
                    ...
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            <div class="service-icon flex-shrink-0">
                                <img src="../icons/escritorio (1).png" alt="">
                            </div>
