...
{
    $stmt = $conexion->prepare("SELECT IdCategoria, Nombre, Descripcion, Precio FROM catproducto WHERE IdCategoria = '19' AND IdProducto = :idProducto");
...
try {
    $categoriaQuery = $conexion->prepare("SELECT IdCategoria, Nombre, Descripcion FROM catcategoria WHERE IdCategoria = '19'");
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <img class="img-fluid" src="../icons/ipad.png" alt="">
            </div>
...
<div class="container-xxl py-5">
    <div class="container px-lg-5">
        ...
        <div class="row g-4">
            ...
            $productosIds = [158,159,160,161,162];
