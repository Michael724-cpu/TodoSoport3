...
{
    $stmt = $conexion->prepare("SELECT IdCategoria, Nombre, Descripcion, Precio FROM catproducto WHERE IdCategoria = '13' AND IdProducto = :idProducto");
...
try {
    $categoriaQuery = $conexion->prepare("SELECT IdCategoria, Nombre, Descripcion FROM catcategoria WHERE IdCategoria = '13'");
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <img class="img-fluid" src="../icons/linux.png" alt="">
            </div>
...
<div class="container-xxl py-5">
    <div class="container px-lg-5">
        ...
        <div class="row g-4">
            ...
            $productosIds = [223,224,225,226,227,228,229,230,231,232,233,234,235];
